...
from ..models import User, OnlineInfo, Role
from . import main
from flask_login import login_required, current_user
from .forms import EditProfileForm, EditProfileAdminForm, PostForm
from ..models import db, Permission, Post
...
def user(username):
    ...
    posts = account.posts.order_by(Post.timestamp.desc()).all()
    ...
    return render_template('user.html', posts=posts,
                           self_info=self_info, users=users,
                           register_status=register_status, account=account)
